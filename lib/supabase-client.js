...
export async function signInWithGmail() {
  // v3.20.9: Use browser.identity.launchWebAuthFlow for proper OAuth in extension.
  // Sebelumnya: redirect ke popup.html → Supabase tidak punya extension URL di
  // allowed redirect URLs → redirect ke PWA instead → login di PWA bukan di addon.
  // Sekarang: launchWebAuthFlow handles redirect internally, no Supabase dashboard config needed.
