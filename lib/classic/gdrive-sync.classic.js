 ...
 */
async function isGDriveSyncEnabled() {
  try {
 ...
 */
async function notify(action, data) {
 ...
 */
async function uploadScreenshot(screenshotItem, dataUrl) {
 ...
 */
async function sendFullBackup(payload) {
