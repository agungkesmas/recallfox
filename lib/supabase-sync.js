...
export function triggerAutoSync() {
  ...
  _autoSyncTimer = setTimeout(async () => {
    ...
    try {
      ...
      // yang hapus item lokal yang sudah di-hard-delete di cloud. Variant lama
      // (pullFromSupabase) tidak ada reconciliation, jadi item yang dihapus di
      // PWA tetap muncul di addon.
