...
export async function addItem(item) {
  ...
  // Untuk screenshot, perlu kirim blob juga — pass lewat screenshotDataUrl.
  // Fire-and-forget supaya UI tidak nunggu network, tapi tetap immediate.
  if (type === 'screenshot' && screenshotBlob) {
    newItem.screenshotDataUrl = screenshotBlob;
  }
  import('./supabase-sync.js').then(mod => {
    if (mod.directUpsertVaultItem) {
      mod.directUpsertVaultItem(newItem).catch(() => {});
    }
  }).catch(() => {});
...
export async function updateItem(id, patch) {
  ...
  import('./supabase-sync.js').then(mod => {
    if (mod.directUpsertVaultItem) {
      mod.directUpsertVaultItem(updated).catch(() => {});
    }
  }).catch(() => {});
...
export async function deleteItem(id) {
  ...
  import('./supabase-sync.js').then(mod => {
    if (mod.directDeleteVaultItem) {
      mod.directDeleteVaultItem(id).catch(() => {});
    }
  }).catch(() => {});
...
export async function addNote(body = '', opts = {}) {
  ...
  import('./supabase-sync.js').then(mod => {
    if (mod.directUpsertNote) {
      mod.directUpsertNote(note).catch(() => {});
    }
  }).catch(() => {});
...
export async function updateNote(id, patch) {
  ...
  import('./supabase-sync.js').then(mod => {
    if (mod.directUpsertNote) {
      mod.directUpsertNote(notes[idx]).catch(() => {});
    }
  }).catch(() => {});
