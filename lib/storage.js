...
const DEFAULT_SETTINGS = {
  ...
  // v3.10.3 (Issue 1): Hapus redirect youtubekids.com (ribet, user tidak suka).
  // Sekarang Mode Anak = filter di youtube.com biasa: hanya konten ramah anak + islami
  // yang tampil, lainnya di-hide sementara. Default ON saat user toggle Mode Anak.
  contentGuardBlockShorts: false,           // Sembunyikan SEMUA YouTube Shorts (feed + /shorts/ URL)
  contentGuardYoutubeKidsOnly: false,       // DEPRECATED v3.10.3 — diset false permanen, tidak dipakai lagi.
                                            // Flag dipertahankan agar tidak break vault lama, tapi
                                            // background.js tidak akan pernah mengaktifkan redirect.
  contentGuardKidModeFilter: false,         // v3.10.0+3.10.3: Mode Anak — filter konten di youtube.com.
                                            // Hide SEMUA video kecuali whitelist ramah-anak + islami.
