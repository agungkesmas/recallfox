...
(async function () {
  ...
  // script Firefox (Bugzilla 1536094) — fallback ke global classic preload.
  let notesLib = null;
  ...
  const RFN_LOAD_INSTANCES = notesLib && notesLib.loadInstances;
  const RFN_SAVE_INSTANCES = notesLib && notesLib.saveInstances;
