...
Catatan paritas Firefox: seluruh perbaikan di atas berlaku identik di build Firefox. Jalur khusus Firefox (preload lib classic `__RF_LIB_NOTES__`, shim edit RecallNote v3.24.3) tidak disentuh; `content/capture.js` & `content/annotate.js` md5-identik dengan repo Chrome.
